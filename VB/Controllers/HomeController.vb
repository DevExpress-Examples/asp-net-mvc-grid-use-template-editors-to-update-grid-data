...
Namespace Example.Controllers
    ...
    Public Class HomeController
        ...
        Public Function UpdateValue(ByVal key As Integer, ByVal field As String, ByVal value As String) As ActionResult
            ' some delay 
        ...
        Public Property GetList As IList(Of MyItem)
            Get
                ...
                If Session(SessionKey) Is Nothing Then
                    itemList = New List(Of MyItem) From {New MyItem With {.Id = 1, .Text = "Text1", .Item = 1}, New MyItem With {.Id = 2, .Text = "Text2", .Item = 2}, New MyItem With {.Id = 3, .Text = "Text3", .Item = 1}, New MyItem With {.Id = 4, .Text = "Text4", .Item = 2}}
